...
void ofApp::setup()
{
	...
	*/
	...
	commandsMap[livelily]["\\livelily"] = ofColor::fuchsia;
	commandsMap[livelily]["\\python"] = ofColor::fuchsia;
	commandsMap[livelily]["\\lua"] = ofColor::fuchsia;
	commandsMap[livelily]["\\listaudiodev"] = ofColor::fuchsia;
	commandsMap[livelily]["\\setaudiodev"] = ofColor::fuchsia;
	commandsMap[livelily]["\\setinaudiodev"] = ofColor::fuchsia;
	commandsMap[livelily]["\\setoutaudiodev"] = ofColor::fuchsia;
	commandsMap[livelily]["\\samplerate"] = ofColor::fuchsia;
	commandsMap[livelily]["\\buffersize"] = ofColor::fuchsia;
	commandsMap[livelily]["\\nchannels"] = ofColor::fuchsia;
	...
	commandsMap[livelily]["beatsin"] = ofColor::violet;
	...
	commandsMap[livelily]["mainaddr"] = ofColor::violet;
	commandsMap[livelily]["valndx"] = ofColor::violet;
	commandsMap[livelily]["toggleaddr"] = ofColor::violet;
	commandsMap[livelily]["resetaddr"] = ofColor::violet;
	...
	commandsMap[livelily]["python"] = ofColor::skyBlue;
	...
	*/
	// keywords
	commandsMap[python]["if"] = ofColor::violet;
	commandsMap[python]["elif"] = ofColor::violet;
	commandsMap[python]["else"] = ofColor::violet;
	commandsMap[python]["for"] = ofColor::violet;
	commandsMap[python]["is"] = ofColor::violet;
	commandsMap[python]["and"] = ofColor::violet;
	commandsMap[python]["not"] = ofColor::violet;
	commandsMap[python]["break"] = ofColor::violet;
	commandsMap[python]["class"] = ofColor::violet;
	commandsMap[python]["continue"] = ofColor::violet;
	commandsMap[python]["def"] = ofColor::violet;
	commandsMap[python]["del"] = ofColor::violet;
	commandsMap[python]["False"] = ofColor::violet;
	commandsMap[python]["True"] = ofColor::violet;
	commandsMap[python]["from"] = ofColor::violet;
	commandsMap[python]["import"] = ofColor::violet;
	commandsMap[python]["as"] = ofColor::violet;
	commandsMap[python]["assert"] = ofColor::violet;
	commandsMap[python]["global"] = ofColor::violet;
	commandsMap[python]["in"] = ofColor::violet;
	commandsMap[python]["lambda"] = ofColor::violet;
	commandsMap[python]["None"] = ofColor::violet;
	commandsMap[python]["nonlocal"] = ofColor::violet;
	commandsMap[python]["not"] = ofColor::violet;
	commandsMap[python]["or"] = ofColor::violet;
	commandsMap[python]["pass"] = ofColor::violet;
	commandsMap[python]["raise"] = ofColor::violet;
	commandsMap[python]["return"] = ofColor::violet;
	commandsMap[python]["try"] = ofColor::violet;
	commandsMap[python]["except"] = ofColor::violet;
	commandsMap[python]["finally"] = ofColor::violet;
	commandsMap[python]["while"] = ofColor::violet;
	commandsMap[python]["with"] = ofColor::violet;
	commandsMap[python]["yield"] = ofColor::violet;

	// Pyo classes
	commandsMap[python]["Server"] = ofColor::skyBlue;
	commandsMap[python]["MidiListener"] = ofColor::skyBlue;
	commandsMap[python]["MidiDispatcher"] = ofColor::skyBlue;
	commandsMap[python]["OscListener"] = ofColor::skyBlue;
	commandsMap[python]["PyoBaseObject"] = ofColor::skyBlue;
	commandsMap[python]["PyoObject"] = ofColor::skyBlue;
	commandsMap[python]["PyoTableObject"] = ofColor::skyBlue;
	commandsMap[python]["PyoMatrixObject"] = ofColor::skyBlue;
	commandsMap[python]["PyoPVObject"] = ofColor::skyBlue;
	commandsMap[python]["Follower"] = ofColor::skyBlue;
	commandsMap[python]["Follower2"] = ofColor::skyBlue;
	commandsMap[python]["ZCross"] = ofColor::skyBlue;
	commandsMap[python]["Yin"] = ofColor::skyBlue;
	commandsMap[python]["Centroid"] = ofColor::skyBlue;
	commandsMap[python]["AttackDetector"] = ofColor::skyBlue;
	commandsMap[python]["Spectrum"] = ofColor::skyBlue;
	commandsMap[python]["Scope"] = ofColor::skyBlue;
	commandsMap[python]["PeakAmp"] = ofColor::skyBlue;
	commandsMap[python]["RMS"] = ofColor::skyBlue;
	commandsMap[python]["Sin"] = ofColor::skyBlue;
	commandsMap[python]["Cos"] = ofColor::skyBlue;
	commandsMap[python]["Tan"] = ofColor::skyBlue;
	commandsMap[python]["Tanh"] = ofColor::skyBlue;
	commandsMap[python]["Abs"] = ofColor::skyBlue;
	commandsMap[python]["Sqrt"] = ofColor::skyBlue;
	commandsMap[python]["Log"] = ofColor::skyBlue;
	commandsMap[python]["Log2"] = ofColor::skyBlue;
	commandsMap[python]["Log10"] = ofColor::skyBlue;
	commandsMap[python]["Atan2"] = ofColor::skyBlue;
	commandsMap[python]["Floor"] = ofColor::skyBlue;
	commandsMap[python]["Ceil"] = ofColor::skyBlue;
	commandsMap[python]["Round"] = ofColor::skyBlue;
	commandsMap[python]["Pow"] = ofColor::skyBlue;
	commandsMap[python]["Exp"] = ofColor::skyBlue;
	commandsMap[python]["Div"] = ofColor::skyBlue;
	commandsMap[python]["Sub"] = ofColor::skyBlue;
	commandsMap[python]["Fader"] = ofColor::skyBlue;
	commandsMap[python]["Adsr"] = ofColor::skyBlue;
	commandsMap[python]["Linseg"] = ofColor::skyBlue;
	commandsMap[python]["Expseg"] = ofColor::skyBlue;
	commandsMap[python]["Sig"] = ofColor::skyBlue;
	commandsMap[python]["SigTo"] = ofColor::skyBlue;
	commandsMap[python]["Clip"] = ofColor::skyBlue;
	commandsMap[python]["Degrade"] = ofColor::skyBlue;
	commandsMap[python]["Mirror"] = ofColor::skyBlue;
	commandsMap[python]["Compress"] = ofColor::skyBlue;
	commandsMap[python]["Gate"] = ofColor::skyBlue;
	commandsMap[python]["Balance"] = ofColor::skyBlue;
	commandsMap[python]["Min"] = ofColor::skyBlue;
	commandsMap[python]["Max"] = ofColor::skyBlue;
	commandsMap[python]["Wrap"] = ofColor::skyBlue;
	commandsMap[python]["Expand"] = ofColor::skyBlue;
	commandsMap[python]["Disto"] = ofColor::skyBlue;
	commandsMap[python]["Delay"] = ofColor::skyBlue;
	commandsMap[python]["SDelay"] = ofColor::skyBlue;
	commandsMap[python]["Delay1"] = ofColor::skyBlue;
	commandsMap[python]["Waveguide"] = ofColor::skyBlue;
	commandsMap[python]["AllpassWV"] = ofColor::skyBlue;
	commandsMap[python]["Freeverb"] = ofColor::skyBlue;
	commandsMap[python]["Convolve"] = ofColor::skyBlue;
	commandsMap[python]["WGVerb"] = ofColor::skyBlue;
	commandsMap[python]["Chorus"] = ofColor::skyBlue;
	commandsMap[python]["Harmonizer"] = ofColor::skyBlue;
	commandsMap[python]["FreqShift"] = ofColor::skyBlue;
	commandsMap[python]["STRev"] = ofColor::skyBlue;
	commandsMap[python]["SmoothDelay"] = ofColor::skyBlue;
	commandsMap[python]["EventScale"] = ofColor::skyBlue;
	commandsMap[python]["EventGenerator"] = ofColor::skyBlue;
	commandsMap[python]["EventDummy"] = ofColor::skyBlue;
	commandsMap[python]["EventFilter"] = ofColor::skyBlue;
	commandsMap[python]["EventKey"] = ofColor::skyBlue;
	commandsMap[python]["EventSeq"] = ofColor::skyBlue;
	commandsMap[python]["EventSlide"] = ofColor::skyBlue;
	commandsMap[python]["EventIndex"] = ofColor::skyBlue;
	commandsMap[python]["EventMarkov"] = ofColor::skyBlue;
	commandsMap[python]["EventChoice"] = ofColor::skyBlue;
	commandsMap[python]["EventDrunk"] = ofColor::skyBlue;
	commandsMap[python]["EventNoise"] = ofColor::skyBlue;
	commandsMap[python]["EventCall"] = ofColor::skyBlue;
	commandsMap[python]["EventConditional"] = ofColor::skyBlue;
	commandsMap[python]["EventInstrument"] = ofColor::skyBlue;
	commandsMap[python]["Events"] = ofColor::skyBlue;
	commandsMap[python]["Biquad"] = ofColor::skyBlue;
	commandsMap[python]["Biquadx"] = ofColor::skyBlue;
	commandsMap[python]["Biquada"] = ofColor::skyBlue;
	commandsMap[python]["EQ"] = ofColor::skyBlue;
	commandsMap[python]["Tone"] = ofColor::skyBlue;
	commandsMap[python]["Atone"] = ofColor::skyBlue;
	commandsMap[python]["Port"] = ofColor::skyBlue;
	commandsMap[python]["DCBlock"] = ofColor::skyBlue;
	commandsMap[python]["BandSplit"] = ofColor::skyBlue;
	commandsMap[python]["FourBand"] = ofColor::skyBlue;
	commandsMap[python]["MultiBand"] = ofColor::skyBlue;
	commandsMap[python]["Hilbert"] = ofColor::skyBlue;
	commandsMap[python]["Allpass"] = ofColor::skyBlue;
	commandsMap[python]["Allpass2"] = ofColor::skyBlue;
	commandsMap[python]["Phaser"] = ofColor::skyBlue;
	commandsMap[python]["Vocoder"] = ofColor::skyBlue;
	commandsMap[python]["IRWinSync"] = ofColor::skyBlue;
	commandsMap[python]["IRAverage"] = ofColor::skyBlue;
	commandsMap[python]["IRPulse"] = ofColor::skyBlue;
	commandsMap[python]["IRFM"] = ofColor::skyBlue;
	commandsMap[python]["SVF"] = ofColor::skyBlue;
	commandsMap[python]["SVF2"] = ofColor::skyBlue;
	commandsMap[python]["Average"] = ofColor::skyBlue;
	commandsMap[python]["Reson"] = ofColor::skyBlue;
	commandsMap[python]["Resonx"] = ofColor::skyBlue;
	commandsMap[python]["ButLP"] = ofColor::skyBlue;
	commandsMap[python]["ButHP"] = ofColor::skyBlue;
	commandsMap[python]["ButBP"] = ofColor::skyBlue;
	commandsMap[python]["ButBR"] = ofColor::skyBlue;
	commandsMap[python]["ComplexRes"] = ofColor::skyBlue;
	commandsMap[python]["MoogLP"] = ofColor::skyBlue;
	commandsMap[python]["FFT"] = ofColor::skyBlue;
	commandsMap[python]["IFFT"] = ofColor::skyBlue;
	commandsMap[python]["PolToCar"] = ofColor::skyBlue;
	commandsMap[python]["CarToPol"] = ofColor::skyBlue;
	commandsMap[python]["FrameAccum"] = ofColor::skyBlue;
	commandsMap[python]["FrameDelta"] = ofColor::skyBlue;
	commandsMap[python]["CvlVerb"] = ofColor::skyBlue;
	commandsMap[python]["Vectral"] = ofColor::skyBlue;
	commandsMap[python]["IFFTMatrix"] = ofColor::skyBlue;
	commandsMap[python]["PVAnal"] = ofColor::skyBlue;
	commandsMap[python]["PVSynth"] = ofColor::skyBlue;
	commandsMap[python]["PVAddSynth"] = ofColor::skyBlue;
	commandsMap[python]["PVTranspose"] = ofColor::skyBlue;
	commandsMap[python]["PVVerb"] = ofColor::skyBlue;
	commandsMap[python]["PVGate"] = ofColor::skyBlue;
	commandsMap[python]["PVCross"] = ofColor::skyBlue;
	commandsMap[python]["PVMult"] = ofColor::skyBlue;
	commandsMap[python]["PVMorph"] = ofColor::skyBlue;
	commandsMap[python]["PVFilter"] = ofColor::skyBlue;
	commandsMap[python]["PVDelay"] = ofColor::skyBlue;
	commandsMap[python]["PVBuffer"] = ofColor::skyBlue;
	commandsMap[python]["PVShift"] = ofColor::skyBlue;
	commandsMap[python]["PVAmpMod"] = ofColor::skyBlue;
	commandsMap[python]["PVFreqMod"] = ofColor::skyBlue;
	commandsMap[python]["PVBufLoops"] = ofColor::skyBlue;
	commandsMap[python]["PVBufTabLoops"] = ofColor::skyBlue;
	commandsMap[python]["PVMix"] = ofColor::skyBlue;
	commandsMap[python]["Blit"] = ofColor::skyBlue;
	commandsMap[python]["BrownNoise"] = ofColor::skyBlue;
	commandsMap[python]["ChenLee"] = ofColor::skyBlue;
	commandsMap[python]["CrossFM"] = ofColor::skyBlue;
	commandsMap[python]["FastSine"] = ofColor::skyBlue;
	commandsMap[python]["FM"] = ofColor::skyBlue;
	commandsMap[python]["Input"] = ofColor::skyBlue;
	commandsMap[python]["LFO"] = ofColor::skyBlue;
	commandsMap[python]["Lorenz"] = ofColor::skyBlue;
	commandsMap[python]["Noise"] = ofColor::skyBlue;
	commandsMap[python]["Phasor"] = ofColor::skyBlue;
	commandsMap[python]["PinkNoise"] = ofColor::skyBlue;
	commandsMap[python]["RCOsc"] = ofColor::skyBlue;
	commandsMap[python]["Rossler"] = ofColor::skyBlue;
	commandsMap[python]["Sine"] = ofColor::skyBlue;
	commandsMap[python]["SineLoop"] = ofColor::skyBlue;
	commandsMap[python]["SumOsc"] = ofColor::skyBlue;
	commandsMap[python]["SuperSaw"] = ofColor::skyBlue;
	commandsMap[python]["Dummy"] = ofColor::skyBlue;
	commandsMap[python]["InputFader"] = ofColor::skyBlue;
	commandsMap[python]["Mix"] = ofColor::skyBlue;
	commandsMap[python]["VarPort"] = ofColor::skyBlue;
	commandsMap[python]["Stream"] = ofColor::skyBlue;
	commandsMap[python]["MatrixMorph"] = ofColor::skyBlue;
	commandsMap[python]["MatrixPointer"] = ofColor::skyBlue;
	commandsMap[python]["MatrixRec"] = ofColor::skyBlue;
	commandsMap[python]["MatrixRecLoop"] = ofColor::skyBlue;
	commandsMap[python]["Bendin"] = ofColor::skyBlue;
	commandsMap[python]["CtlScan"] = ofColor::skyBlue;
	commandsMap[python]["CtlScan2"] = ofColor::skyBlue;
	commandsMap[python]["MidiAdsr"] = ofColor::skyBlue;
	commandsMap[python]["MidiDelAdsr"] = ofColor::skyBlue;
	commandsMap[python]["MidiCtl"] = ofColor::skyBlue;
	commandsMap[python]["Notein"] = ofColor::skyBlue;
	commandsMap[python]["Programin"] = ofColor::skyBlue;
	commandsMap[python]["Touchin"] = ofColor::skyBlue;
	commandsMap[python]["RawMidi"] = ofColor::skyBlue;
	commandsMap[python]["MidiLinseg"] = ofColor::skyBlue;
	commandsMap[python]["MML"] = ofColor::skyBlue;
	commandsMap[python]["OscDataReceive"] = ofColor::skyBlue;
	commandsMap[python]["OscDataSend"] = ofColor::skyBlue;
	commandsMap[python]["OscListReceive"] = ofColor::skyBlue;
	commandsMap[python]["OscReceive"] = ofColor::skyBlue;
	commandsMap[python]["OscSend"] = ofColor::skyBlue;
	commandsMap[python]["Mixer"] = ofColor::skyBlue;
	commandsMap[python]["Pan"] = ofColor::skyBlue;
	commandsMap[python]["SPan"] = ofColor::skyBlue;
	commandsMap[python]["Selector"] = ofColor::skyBlue;
	commandsMap[python]["Switch"] = ofColor::skyBlue;
	commandsMap[python]["VoiceManager"] = ofColor::skyBlue;
	commandsMap[python]["HRTF"] = ofColor::skyBlue;
	commandsMap[python]["Binaural"] = ofColor::skyBlue;
	commandsMap[python]["CallAfter"] = ofColor::skyBlue;
	commandsMap[python]["Pattern"] = ofColor::skyBlue;
	commandsMap[python]["Score"] = ofColor::skyBlue;
	commandsMap[python]["SfPlayer"] = ofColor::skyBlue;
	commandsMap[python]["SfMarkerLooper"] = ofColor::skyBlue;
	commandsMap[python]["SfMarkerShuffler"] = ofColor::skyBlue;
	commandsMap[python]["LogiMap"] = ofColor::skyBlue;
	commandsMap[python]["RandDur"] = ofColor::skyBlue;
	commandsMap[python]["RandInt"] = ofColor::skyBlue;
	commandsMap[python]["Randh"] = ofColor::skyBlue;
	commandsMap[python]["Randi"] = ofColor::skyBlue;
	commandsMap[python]["Urn"] = ofColor::skyBlue;
	commandsMap[python]["XNoise"] = ofColor::skyBlue;
	commandsMap[python]["XNoiseDur"] = ofColor::skyBlue;
	commandsMap[python]["XNoiseMidi"] = ofColor::skyBlue;
	commandsMap[python]["Granulator"] = ofColor::skyBlue;
	commandsMap[python]["Granule"] = ofColor::skyBlue;
	commandsMap[python]["Lookup"] = ofColor::skyBlue;
	commandsMap[python]["Looper"] = ofColor::skyBlue;
	commandsMap[python]["Osc"] = ofColor::skyBlue;
	commandsMap[python]["OscBank"] = ofColor::skyBlue;
	commandsMap[python]["OscLoop"] = ofColor::skyBlue;
	commandsMap[python]["OscTrig"] = ofColor::skyBlue;
	commandsMap[python]["Particle"] = ofColor::skyBlue;
	commandsMap[python]["Particle2"] = ofColor::skyBlue;
	commandsMap[python]["Pointer"] = ofColor::skyBlue;
	commandsMap[python]["Pointer2"] = ofColor::skyBlue;
	commandsMap[python]["Pulsar"] = ofColor::skyBlue;
	commandsMap[python]["TableIndex"] = ofColor::skyBlue;
	commandsMap[python]["TableMorph"] = ofColor::skyBlue;
	commandsMap[python]["TablePut"] = ofColor::skyBlue;
	commandsMap[python]["TableRead"] = ofColor::skyBlue;
	commandsMap[python]["TableRec"] = ofColor::skyBlue;
	commandsMap[python]["TableWrite"] = ofColor::skyBlue;
	commandsMap[python]["TableScale"] = ofColor::skyBlue;
	commandsMap[python]["TableFill"] = ofColor::skyBlue;
	commandsMap[python]["TableScan"] = ofColor::skyBlue;
	commandsMap[python]["Beat"] = ofColor::skyBlue;
	commandsMap[python]["Change"] = ofColor::skyBlue;
	commandsMap[python]["Cloud"] = ofColor::skyBlue;
	commandsMap[python]["Count"] = ofColor::skyBlue;
	commandsMap[python]["Counter"] = ofColor::skyBlue;
	commandsMap[python]["Euclide"] = ofColor::skyBlue;
	commandsMap[python]["Iter"] = ofColor::skyBlue;
	commandsMap[python]["Metro"] = ofColor::skyBlue;
	commandsMap[python]["NextTrig"] = ofColor::skyBlue;
	commandsMap[python]["Percent"] = ofColor::skyBlue;
	commandsMap[python]["Select"] = ofColor::skyBlue;
	commandsMap[python]["Seq"] = ofColor::skyBlue;
	commandsMap[python]["Thresh"] = ofColor::skyBlue;
	commandsMap[python]["Timer"] = ofColor::skyBlue;
	commandsMap[python]["Trig"] = ofColor::skyBlue;
	commandsMap[python]["TrigBurst"] = ofColor::skyBlue;
	commandsMap[python]["TrigChoice"] = ofColor::skyBlue;
	commandsMap[python]["TrigEnv"] = ofColor::skyBlue;
	commandsMap[python]["TrigExpseg"] = ofColor::skyBlue;
	commandsMap[python]["TrigFunc"] = ofColor::skyBlue;
	commandsMap[python]["TrigLinseg"] = ofColor::skyBlue;
	commandsMap[python]["TrigRand"] = ofColor::skyBlue;
	commandsMap[python]["TrigRandInt"] = ofColor::skyBlue;
	commandsMap[python]["TrigTableRec"] = ofColor::skyBlue;
	commandsMap[python]["TrigVal"] = ofColor::skyBlue;
	commandsMap[python]["TrigXnoise"] = ofColor::skyBlue;
	commandsMap[python]["TrigXnoiseMidi"] = ofColor::skyBlue;
	commandsMap[python]["AToDB"] = ofColor::skyBlue;
	commandsMap[python]["Between"] = ofColor::skyBlue;
	commandsMap[python]["CentsToTranspo"] = ofColor::skyBlue;
	commandsMap[python]["Clean_objects"] = ofColor::skyBlue;
	commandsMap[python]["Compare"] = ofColor::skyBlue;
	commandsMap[python]["ConotrolRead"] = ofColor::skyBlue;
	commandsMap[python]["ConotrolRec"] = ofColor::skyBlue;
	commandsMap[python]["DBToA"] = ofColor::skyBlue;
	commandsMap[python]["Denorm"] = ofColor::skyBlue;
	commandsMap[python]["FToM"] = ofColor::skyBlue;
	commandsMap[python]["Interp"] = ofColor::skyBlue;
	commandsMap[python]["MToF"] = ofColor::skyBlue;
	commandsMap[python]["MToT"] = ofColor::skyBlue;
	commandsMap[python]["NoteinRead"] = ofColor::skyBlue;
	commandsMap[python]["NoteinRec"] = ofColor::skyBlue;
	commandsMap[python]["Print"] = ofColor::skyBlue;
	commandsMap[python]["Record"] = ofColor::skyBlue;
	commandsMap[python]["SampHold"] = ofColor::skyBlue;
	commandsMap[python]["Scale"] = ofColor::skyBlue;
	commandsMap[python]["Snap"] = ofColor::skyBlue;
	commandsMap[python]["TranspoToCents"] = ofColor::skyBlue;
	commandsMap[python]["TrackHold"] = ofColor::skyBlue;
	commandsMap[python]["Resample"] = ofColor::skyBlue;
	commandsMap[python]["ChebyTable"] = ofColor::skyBlue;
	commandsMap[python]["CosLogTable"] = ofColor::skyBlue;
	commandsMap[python]["CosTable"] = ofColor::skyBlue;
	commandsMap[python]["CurvyTable"] = ofColor::skyBlue;
	commandsMap[python]["DataTable"] = ofColor::skyBlue;
	commandsMap[python]["ExpTable"] = ofColor::skyBlue;
	commandsMap[python]["HannTable"] = ofColor::skyBlue;
	commandsMap[python]["HarmTable"] = ofColor::skyBlue;
	commandsMap[python]["LinTable"] = ofColor::skyBlue;
	commandsMap[python]["LogTable"] = ofColor::skyBlue;
	commandsMap[python]["NewTable"] = ofColor::skyBlue;
	commandsMap[python]["ParaTable"] = ofColor::skyBlue;
	commandsMap[python]["PartialTable"] = ofColor::skyBlue;
	commandsMap[python]["SawTable"] = ofColor::skyBlue;
	commandsMap[python]["SyncTable"] = ofColor::skyBlue;
	commandsMap[python]["SndTable"] = ofColor::skyBlue;
	commandsMap[python]["SquareTable"] = ofColor::skyBlue;
	commandsMap[python]["TriangleTable"] = ofColor::skyBlue;
	commandsMap[python]["WinTable"] = ofColor::skyBlue;
	commandsMap[python]["AtanTable"] = ofColor::skyBlue;
	commandsMap[python]["PadSynthTable"] = ofColor::skyBlue;
	commandsMap[python]["SharedTable"] = ofColor::skyBlue;
	commandsMap[python]["NewMatrix"] = ofColor::skyBlue;
	commandsMap[python]["Map"] = ofColor::skyBlue;
	commandsMap[python]["SLMap"] = ofColor::skyBlue;
	commandsMap[python]["SLMapFreq"] = ofColor::skyBlue;
	commandsMap[python]["SLMapMul"] = ofColor::skyBlue;
	commandsMap[python]["SLMapPhase"] = ofColor::skyBlue;
	commandsMap[python]["SLMapQ"] = ofColor::skyBlue;
	commandsMap[python]["SLMapDur"] = ofColor::skyBlue;
	commandsMap[python]["SLMapPan"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiControlSlider"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiVuMeter"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiGrapher"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiMultiSlider"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiSpectrum"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiScope"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiSndView"] = ofColor::skyBlue;
	commandsMap[python]["PyGuiKeyboard"] = ofColor::skyBlue;
	...
	noIndentCheck[livelily].push_back("\\list");
...
void ofApp::executeKeyPressed(int key)
{
	switch (key) {
	    ...
	    default:
			...
			// Ctrl+Alt+Shift+P for full screen
			...
			else if (!editors[whichPane].getInserting() && ((key == 58 && !editors[whichPane].getVisualMode()) || editors[whichPane].isTypingCommand())) {
				editors[whichPane].typeCommand(key);
			}
			else if (!editors[whichPane].getInserting() && !editors[whichPane].isTypingCommand()) {
				if ((key == 106 || key == 74)) {
				...
				else if ((key == 102 && ctrlPressed)) {
					if (editors[whichPane].getVisualMode()) editors[whichPane].setShiftPressed(true);
					editors[whichPane].pageDown();
					if (editors[whichPane].getVisualMode()) editors[whichPane].setShiftPressed(false);
				}
				else if ((key == 98 && ctrlPressed)) {
					if (editors[whichPane].getVisualMode()) editors[whichPane].setShiftPressed(true);
					editors[whichPane].pageUp();
					if (editors[whichPane].getVisualMode()) editors[whichPane].setShiftPressed(false);
				}
...
CmdOutput ofApp::parseCommand(CmdInput cmdInput, int lineNum, int numLines)
{
	...
	if (cmdInput.inputVec[0].compare("\\time") == 0) {
		...
		// store the time information to the barLines string
		int barIndex = getLastLoopIndex();
		...
		sharedData.beatAtDifferentThanDivisor[bar] = true;
		// store the beatat information to the barLines string
		int barIndex = getLastLoopIndex();
		//for (int i = 0; i < editors[whichPane].getTabSize()-1; i++) {
		//	sharedData.barLines[sharedData.barsOrdered[barIndex]] += " ";
		//}
		...
		if (cmdInput.inputVec[1] == "\\bar") {
			...
			// the vector of the command input includes both the \transposed command and the name of the instrument
		...
		map<char, int> notes = {{'c', 0}, {'d', 2}, {'e', 4}, {'f', 5}, {'g', 7}, {'a', 9}, {'b', 11}};
		map<int, string> semitones = {{0, "c"}, {2, "d"}, {4, "e"}, {5, "f"}, {7, "g"}, {9, "a"}, {11, "b"}};
		vector<string> output;
		...
		// again test if greater than and not if greater than or equal to
		// -1 is there because the input vector contains the command too
		if (cmdInput.inputVec.size()-1 > sharedData.instruments.size()) {
	...
	// currently default Note On duration, staccato, staccatissimo, and tenuto
		...
		vector<ofSoundDevice> v = soundStream.getDeviceList();
		string audioDevs = "";
		for (size_t i = 0; i < v.size(); i++) {
			if (i > 0) audioDevs += "\n";
			audioDevs += to_string(i) + ": " + v.at(i).name;
		}
			...
			if (commands.size() > 1) {
				...
				if (commands.size() == 3) {
					...
					for (auto it = barLinesTokens.begin(); it != barLinesTokens.end(); ++it) {
						vector<string> instBarLinesTokens = tokenizeExpandedCommands(*it);
						...
						if (instBarLinesTokens.size() > 0 && instBarLinesTokens.at(0).substr(instNameNdx) == commands[1]) {
							vector<string> v = {instBarLinesTokens.at(0).substr(instNameNdx)};
...
//--------------------------------------------------------------
CmdOutput ofApp::stripLineFromBar(vector<string> tokens, int lineNum, int numLines)
{
	...
	for (auto it = tokens.begin(); it != tokens.end(); ++it) {
		...
		if (tabNdx != string::npos && (*it).substr(tabNdx+1) == "\\" + sharedData.instruments[lastInstrumentIndex].getName()) {
			newTokens.push_back((*it).substr(tabNdx+1));
			startPushing = true;
		}
		//else if (openCurlyBracketNdx != string::npos && sharedData.instrumentIndexes.find((*it).substr(openCurlyBracketNdx)) != sharedData.instrumentIndexes.end() && 
...
std::pair<int, string> ofApp::parseMelodicLine(vector<string> tokens, int lineNum, int numLines)
{
	...
	//for (int i = 0; i < editors[whichPane].getTabSize(); i++) {
	...
	vector<float> dynamicsData(tokens.size(), 0);
	vector<float> dynamicsRampData(tokens.size(), 0);
				...
				while (index2 < subtokens.back().size()) {
					...
					foundDynamicTest:
						if (foundDynamicLocal) {
							...
							// so to map this range to 82-100 (dB) we must first add 9 (subtract -9)
							...
							int dynamicForScore = distance(scoreDynamics.begin(), find(scoreDynamics.begin(), scoreDynamics.end(), dynamic));
							// and get the mapped values to MIDI velocities and divide by 127 to normalize to 1
	...
	for (i = 0; i < dynamicsRampCounter; i++) {
		...
		float valsDiff = dynamicsData.at(dynamicsRampIndexes.at(i).second) - dynamicsData[dynamicsRampIndexes.at(i).first];
		int midiVelsDiff = midiVels.at(dynamicsRampIndexes.at(i).second) - midiVels[dynamicsRampIndexes.at(i).first];
		float step = valsDiff / max(numSteps, 1);
...
//--------------------------------------------------------------
CmdOutput ofApp::maestroCommands(vector<string>& originalCommands, int lineNum, int numLines)
{
	CmdOutput cmdOutput = CmdOutput();
	// the initial command is \score. followed by a second level command
	// to separate the second level command we create a new vector that will copy the originalCommands vector
	...
	for (unsigned i = 0; i < commands.size(); i++) {
		...
		else if (commands[i].compare("resetaddr") == 0) {
			if (commands.size() < i + 2) {
...
//--------------------------------------------------------------
void Function::copyStr(string s, size_t offset)
{
	strcpy(str+offset, s.c_str());
}

//--------------------------------------------------------------
string Function::printStr()
{
	string strToPrint = "";
...
//--------------------------------------------------------------
void Function::setName(string funcName)
{
	if (funcName.size() > 50) {
		nameError = true;
		return;
...
//--------------------------------------------------------------
void Function::setArgument(string str)
{
	if (numArgs > 50) {
		argErrorType = 1;
		return;
...
//--------------------------------------------------------------
string Function::getArgument(int ndx)
{
	if (ndx >= 50) return "";
									...
									if (instMapIt->second.getSeqToggle()) {
...
#ifdef USEPYO
												string s = instMapIt->second.getName() + ".setAmp(0)";
												sharedData->pyo.exec(s.c_str(), 0);
#endif
											}
											else {
												ofxOscMessage m;
										...
										if (sendData) {
											...
											for (auto it = instMapIt->second.notes[bar][instMapIt->second.getBarDataCounter()].begin(); it != instMapIt->second.notes[bar][instMapIt->second.getBarDataCounter()].end(); ++it) {
												if (instMapIt->second.sendToPython()) {
#ifdef USEPYO
													string s = instMapIt->second.getName() + ".setFreq(" + to_string(midiToFreq(*it)) + ")";
													sharedData->pyo.exec(s.c_str(), 0);
#endif
												}
												else {
											...
											if (instMapIt->second.sendToPython()) {
#ifdef USEPYO
												string s = instMapIt->second.getName() + ".setAmp(" + to_string(instMapIt->second.getDynamic(bar)) + ")";
												sharedData->pyo.exec(s.c_str(), 0);
#endif
											}
											else {
